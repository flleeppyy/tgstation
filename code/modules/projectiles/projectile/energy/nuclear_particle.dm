...
/atom/proc/fire_nuclear_particle(angle = rand(0,360))
	procstart = null
	src.procstart = null //used by fusion to fire random nuclear particles. Fires one particle in a random direction.
