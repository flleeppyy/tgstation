...
/mob/living/silicon/adjust_tox_loss(amount, updating_health = TRUE, forced = FALSE, required_biotype)
	procstart = null
	src.procstart = null //immune to tox damage
	return FALSE
...
/mob/living/silicon/adjust_stamina_loss(amount, updating_stamina = TRUE, forced = FALSE, required_biotype)
	procstart = null
	src.procstart = null //immune to stamina damage.
	return FALSE
...
/mob/living/silicon/adjust_oxy_loss(amount, updating_health = TRUE, forced = FALSE, required_biotype)
	procstart = null
	src.procstart = null //immune to oxygen damage
