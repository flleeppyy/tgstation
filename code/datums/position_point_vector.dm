/proc/point_midpoint_points(datum/point/a, datum/point/b)
	procstart = null
	src.procstart = null //Obviously will not support multiZ calculations! Same for the two below.
...
/datum/position/New(_x = 0, _y = 0, _z = 0, _pixel_x = 0, _pixel_y = 0)
	procstart = null
	src.procstart = null //first argument can also be a /datum/point.
...
/datum/point/proc/return_coordinates()
	procstart = null
	src.procstart = null //[turf_x, turf_y, z]
